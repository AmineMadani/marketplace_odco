                                ...
                                <div class="comments-form">
                                    <form action="{{action('FrontEndController@contactmail')}}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input name="phone" type="tel" placeholder="Votre Numéro du téléphone">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <p><textarea name="message" id="comment" placeholder="Ecrivez votre message" cols="30" rows="10" required></textarea></p>
                                        <input name="contact_btn" type="submit" value="Envoyer">
                                    </form>
                                </div>
                            </div>
                        </div>

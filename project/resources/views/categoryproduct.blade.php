                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                        <div class="product-filter-leftDiv">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="product-filter-option">
                                        <h2 class="filter-title">Filtrage</h2>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="product-filter-option">
                                        <h2 class="filter-title">Toutes les catégories</h2>
                                        <ul>
                        ...
                        <div class="product-filter-rightDiv">
                                        ...
                                        <div class="single-product-carousel-item text-center">
                                            ...
                                            <div class="product-carousel-text">
                                                ...
                                                <div class="product-price">
                                                 ...
                                                 <!--   <del class="offer-price">{{$product->previous_price}}DH</del>-->
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <a href="javascript:;" id="load-more" class="product-filter-loadMore-btn">Charger plus</a>
                                </div>
                            </div>
                            @endif
                        </div>

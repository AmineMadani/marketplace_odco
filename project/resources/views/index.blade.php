                                    ...
                                    <a href="{{url('/category')}}/{{$fcategory->slug}}">
                                        ...
                                        <div class="product-feature-content">
                                            ...
                                            @if(\App\Product::where('status','1')->whereRaw('FIND_IN_SET(?,category)', [$fcategory->id])->count()>1)
                                                <p>{{\App\Product::where('status','1')->whereRaw('FIND_IN_SET(?,category)', [$fcategory->id])->count()}} produits</p>
                                            @else
                                                <p>{{\App\Product::where('status','1')->whereRaw('FIND_IN_SET(?,category)', [$fcategory->id])->count()}} produit</p>
                                            @endif
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <a href="{{url('/category')}}/{{$fcat->slug}}">
                                        ...
                                        <div class="product-feature-content">
                                            ...
                                            @if(\App\Product::where('status','1')->whereRaw('FIND_IN_SET(?,category)', [$fcat->id])->count()>1)
                                                <p>{{\App\Product::where('status','1')->whereRaw('FIND_IN_SET(?,category)', [$fcat->id])->count()}} produits</p>
                                            @else
                                                <p>{{\App\Product::where('status','1')->whereRaw('FIND_IN_SET(?,category)', [$fcat->id])->count()}} produit</p>
                                            @endif
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <div class="single-product-carousel-item text-center">
                                        ...
                                        <div class="product-carousel-text">
                                            ...
                                            <div class="product-price">
                                                    ...
                                                    <span class="original-price">{{$product->price}}{{$settings[0]->currency_sign}}</span>

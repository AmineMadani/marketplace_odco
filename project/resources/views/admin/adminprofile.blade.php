                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('AdminProfileController@update',['id' => $admin->id]) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <label style="margin-top: 90px;" class="control-label col-md-3 col-sm-3 col-xs-12" for="name">  Photo Actuelle <span class="required">*</span>
                                </label>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <div id="uploadTrigger" onclick="uploadclick()" style="margin-top: 90px;white-space: normal;" class="form-control btn btn-default"><i class="fa fa-upload"></i> Changer la photo</div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <button type="submit" class="btn btn-success btn-block">Editer</button>
                                </div>
                            </div>
                        </form>
                    </div>

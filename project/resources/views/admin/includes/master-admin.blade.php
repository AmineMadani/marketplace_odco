...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a href="{!! url('admin/adminprofile') !!}"><i class="fa fa-fw fa-user"></i> Editer le Profil</a></li>
                <li><a href="{!! url('admin/adminpassword') !!}"><i class="fa fa-fw fa-cog"></i> Changer le mot de passe</a></li>
                <li class="divider"></li>
                <li>
                    <a href="{{ route('logout') }}"
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            <li>
                <a href="{!! url('admin/dashboard') !!}"><i class="fa fa-fw fa-home"></i>  Tableau de bord</a>
            </li>
            <li>
                <a href="{!! url('admin/orders') !!}"><i class="fa fa-fw fa-usd"></i>Commandes</a>
            </li>
           <!-- <li>
           ...
           <!-- <li>
            ...
            <li>
                <a href="{!! url('admin/vendors') !!}"><i class="fa fa-fw fa-group"></i> Coopératives</a>
            </li>
            <li>

...
<head>
    ...
    <title>Administration du MarketPlace</title>
...
<section id="login">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="form-wrap">
                    <h1>Administarion du MarketPlace Bi3&Chri</h1>
                    <hr>
...
<footer id="footer">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <p>2020 Powered by <strong><a href="http://projects.geniusocean.com/newsocean/" target="_blank">Bi3&Chri </a></strong></p>
            </div>
        </div>
    </div>
</footer>

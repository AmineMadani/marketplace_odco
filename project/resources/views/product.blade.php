                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            ...
                            @if($productdata->owner != "admin")
                                @if(\App\Vendors::where('id',$productdata->vendorid)->count() != 0)
                                    <strong class="">{{$language->vendor}}: <a href="{{url('/shop')}}/{{$productdata->vendorid}}/{{str_replace(' ','-',strtolower(\App\Vendors::findOrFail($productdata->vendorid)->coop_name))}}" target="_blank">{{\App\Vendors::findOrFail($productdata->vendorid)->coop_name}}</a></strong>
                                @endif
                            @else
                            @endif
                            ...
                            <div>
                                ...
                                @if(\App\Review::reviewCount($productdata->id) > 1)
                                    <span>{{\App\Review::reviewCount($productdata->id)}} </span>
                                @else
                                    <span>{{\App\Review::reviewCount($productdata->id)}} Avis</span>
                                @endif
                            </div>
                            ...
                            <h1 class="product-price">
                                    ...
                                    {{$productdata->price}}{{$settings[0]->currency_sign}}
                            </h1>
                                    ...
                                    <div class="single-product-carousel-item text-center">
                                        ...
                                        <div class="product-carousel-text">
                                            ...
                                            <div class="product-price">
                                                    <span class="original-price">{{$product->price}}DH</span>

...
<head>
    ...
    <title>{{$settings[0]->title}} - Coopérative</title>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">{{ Auth::user()->coop_name }} <b class="fa fa-angle-down"></b></a>
            <ul class="dropdown-menu">
                <li><a href="{!! url('vendor/vendorprofile') !!}"><i class="fa fa-fw fa-user"></i> Editer ler profile</a></li>
                <li><a href="{!! url('vendor/vendorpassword') !!}"><i class="fa fa-fw fa-cog"></i> Changer le mot de passe</a></li>
                <li class="divider"></li>
                <li>
                    <a href="{{ route('logout') }}"
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            <li>
                <a href="{!! url('vendor/dashboard') !!}"><i class="fa fa-fw fa-home"></i> Tableau de bord</a>
            </li>
            <li>
                <a href="{!! url('vendor/orders') !!}"><i class="fa fa-fw fa-usd"></i> Commandes</a>
            </li>
            <li>
                <a href="{!! url('vendor/products') !!}"><i class="fa fa-fw fa-shopping-cart"></i>Produits</a>
            </li>
           <!-- <li>

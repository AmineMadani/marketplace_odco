                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                <tr id="item{{$cart->product}}">
                                    ...
                                    <td><span id="price{{$cart->product}}">{{\App\Product::Cost($cart->product)}}</span>{{$settings[0]->currency_sign}}</td>
                                    <td><span id="subtotal{{$cart->product}}" class="subtotal">{{$cart->cost}}</span>{{$settings[0]->currency_sign}}</td>
                                </tr>
                                @empty
                                    <tr>
                                        <td colspan="6">
                                ...
                                <tr style="border-top: 1px solid black;">
                                    ...
                                    <td colspan="2" style="text-align: right;">
                                        <h3><span id="grandtotal">{{round($sum,2)}}</span>{{$settings[0]->currency_sign}}</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">

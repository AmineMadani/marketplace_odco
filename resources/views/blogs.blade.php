...
@section('content')
    ...
    <section style="background: url({{url('/')}}/images/{{$settings[0]->background}}) no-repeat center center; background-size: cover;">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 single-blog">
                            <a href="{{url('/')}}/blog/{{$blog->id}}">
                                <div class="blog-thumb-wrapper">
                                    <img src="/images/blog/{{$blog->featured_image}}" alt="Blog Image">
                                </div>
                                <div class="blog-text">
